      ...
      <div className="container">
        <div className="header">
          ...
          <nav className="navigation">
            <ul>
              <li>
                <a className="navigation-link" href="./premium.html">
                  Premium
                </a>
              </li>
              <li>
              ...
              <li>
                <a className="navigation-link" href="./help.html">
                  Help
                </a>
              </li>
              <li>
                <a className="navigation-link" href="./download.html">
                  Download
                </a>
              </li>
              <li className="vertical_separator" />
              <li>
                ...
                <div id="profileMenu" className="profileMenu">
                  <ul className="">
                    <li className="">
                      <a className="" href="./Spotify-songs/songs.html">
                        Welcome
                      </a>
                    </li>
                  </ul>
        ...
        <div id="mySidenav" className="sidenav">
          <ul>
            <li>
              <a className="sidenav-link" href="./premium.html">
                Premium
              </a>
            </li>
            <li>
              <a className="sidenav-link" href="./help.html">
                Help
              </a>
            </li>
            <li>
              <a className="sidenav-link" href="./download.html">
                Download
              </a>
            </li>
            <li className="h_separator" />
            <li>
              <a className="sidenav-link light" href="#">
                Welcome
              </a>
            </li>
            <li>
